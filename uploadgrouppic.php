...
***********************************************************/	
	...
	//Set Upload directory    
		$uploaddir = $_SERVER['DOCUMENT_ROOT'].'/Demo3/assets/images/profile_pics';
	//Set File name	
	...
	//Move the file to correct location
		...
		if (!$move) { 
			...
			$imgSrc= "/Demo3/assets/images/profile_pics/".$file_name; // the image to display in crop area
...
if (isset($_POST['x'])){
	...
	if($type == 'jpg' || $type == 'jpeg' || $type == 'JPG' || $type == 'JPEG'){	
		...
		$insert_pic_query = mysqli_query($con, "UPDATE groups SET group_profile_pic='$result_path' WHERE group_name='$groupname'");
		header("Location: ".$groupname);
...
<div class="main_column column">
	...
	<div id="formExample">
	    ...
	    <form action="uploadgrouppic.php" method="post"  enctype="multipart/form-data">
	        Upload something<br /><br />
	         <input type="hidden" name="pic" value=<?php echo $groupname; ?> > 
    ...
    if($imgSrc){ //if an image has been uploaded display cropping area?>
	    ...
	    <div id="CroppingContainer" style="width:800px; max-height:600px; background-color:#FFF; margin-left: 0px; position:relative; overflow:hidden; border:2px #666 solid; z-index:2001; padding-bottom:0px;">  
	        ...
	        <div id="InfoArea" style="width:180px; height:150px; position:relative; overflow:hidden; margin:40px 0px 0px 40px; border:0px #666 solid; float:left;">	
	           <p style="margin:0px; padding:0px; color:#444; font-size:18px;">          
	                ...
	                <span style="font-size:14px;">
	                    Crop / resize your uploaded group profile image. <br />
	                    Once you are happy with your group profile image then please click save.
	        ...
	        <div id="CropImageForm" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="uploadgrouppic.php" method="post" onsubmit="return checkCoords();">
	        ...
	        <div id="CropImageForm2" style="width:100px; height:30px; float:left; margin:10px 0px 0px 40px;" >  
	            <form action="uploadgrouppic.php" method="post" onsubmit="return cancelCrop();">
 					<input type="hidden" name="pic" value=<?php echo $groupname; ?> >  
