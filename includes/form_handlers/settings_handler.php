...
if(isset($_POST['update_details'])) {
	...
	if($matched_user == "" || $matched_user == $userLoggedIn) {
		...
		$query = mysqli_query($con, "UPDATE users SET first_name='$first_name', last_name='$last_name',anonymous_name='$anonymous_name' ,email='$email' WHERE username='$userLoggedIn'");
	}
	else 
